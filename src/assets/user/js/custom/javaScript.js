...
//   // Hosting Section
//   $('#kt_body .hosting .host-taps li').on('click', function () {
//     $(this).addClass('active').siblings().removeClass('active');
//     $('.host-item').hide();
//     $($(this).data('show')).show();
//     return false;
...
//  $('#kt_body .hosting .host-taps .s-toggler .check').on('click', function () {
//     $(this).parents('.s-toggler').find('.toggler').toggleClass('toggler--is-active');
//     $('#kt_body .hosting .host-items-contain').toggleClass('active--section');
//   });
